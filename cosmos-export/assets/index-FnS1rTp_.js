const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./_virtual_cosmos-imports-C3aRB5tP.js","./_virtual_cosmos-imports-Bv40UXgh.css"])))=>i.map(i=>d[i]);
...
function isMultiFixture(fixtureExport) {
  return fixtureExport !== null && typeof fixtureExport === "object" && !reactExports.isValidElement(fixtureExport) && // With React Server Components, fixture exports of Client fixtures are
...
async function mount() {
  const args = await __vitePreload(() => import("./_virtual_cosmos-imports-C3aRB5tP.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
