...
import { R as React, r as reactExports, a as React$1 } from "./index-FnS1rTp_.js";
...
const LEGO_COLORS = {
  yellow: "#FFCA3A",
  // LEGO Gul - Bakgrunner, paneler, highlight
  red: "#D62828",
  // LEGO Rød - Primærknapper, advarsler
  blue: "#1982C4",
  // LEGO Blå - Sekundærknapper, lenker, header
  black: "#000000",
  // LEGO Svart - Tekst, outlines, ikonfarge
  beige: "#FAF3E0"
  // LEGO Beige - Innskrivingsfelt, kort-bakgrunner
};
    ...
    Card,
    {
      sx: {
        ...
        "&:hover": {
          ...
          boxShadow: onClick ? "6px 6px 0px rgba(0,0,0,0.8)" : "4px 4px 0px rgba(0,0,0,0.8)"
        },
        "&::before": {
          content: '""',
          position: "absolute",
          ...
          right: -2,
          bottom: -2,
          background: `linear-gradient(45deg, ${colors.accent} 0%, transparent 30%, transparent 70%, ${colors.accent} 100%)`,
          borderRadius: 2,
          zIndex: -1,
          opacity: 0.3
        }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { sx: { p: 3, pt: 4 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Typography,
            {
              variant: "h6",
          ...
          progress !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { mb: 2 }, children: [
            progressLabel && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Typography,
              {
                variant: "caption",
                sx: {
          ...
          stats && stats.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Box,
            {
              sx: {
                display: "flex",
              ...
              children: stats.map((stat, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                {
                  sx: {
                    backgroundColor: stat.color || colors.accent,
                    color: "#ffffff",
                    px: 1.5,
                    py: 0.5,
                    borderRadius: 1,
          ...
          tags2 && tags2.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Box,
            {
              sx: {
                display: "flex",
    ...
    Button,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Box,
        {
          ...
          children: [
            icon && iconPosition === "left" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Box,
              {
                sx: {
                  display: "flex",
            ...
            icon && iconPosition === "right" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Box,
              {
                sx: {
                  display: "flex",
...
const LegoCard_fixture = {
  "Collection Card": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        LegoCard,
        {
          ...
          actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 1, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", size: "small", children: "View All" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "secondary", size: "small", children: "Add Set" })
          ] })
        }
      )
    }
  ) }),
  "Set Card": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        LegoCard,
        {
          ...
          actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 1, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", size: "small", children: "Continue" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "secondary", size: "small", children: "Details" })
          ] })
        }
      )
    }
  ) }),
  "Part Card": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        LegoCard,
        {
          ...
          actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 1, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", size: "small", children: "Use in Build" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "secondary", size: "small", children: "Find Sets" })
          ] })
        }
      )
    }
  ) }),
  "All Variants": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
  ...
  "With Progress": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
  ...
  "Interactive Card": () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Box,
      {
        sx: {
          p: 4,
  ...
  "Complex Card": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Typography,
              {
                ...
                children: "En verden bygget av klosser"
              }
            )
          ] })
        ] }),
...
const LegoHeader_fixture = {
  "Logged Out State": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        backgroundColor: legoTheme.palette.background.default,
  ...
  "Logged In State": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        backgroundColor: legoTheme.palette.background.default,
  ...
  "Large Collection": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        backgroundColor: legoTheme.palette.background.default,
  ...
  "New User": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        backgroundColor: legoTheme.palette.background.default,
  ...
  "Interactive Header": () => {
    const [isLoggedIn, setIsLoggedIn] = React$1.useState(false);
    const [collectionCount, setCollectionCount] = React$1.useState(0);
    const [buildableCount, setBuildableCount] = React$1.useState(0);
    const handleLogin = () => {
      setIsLoggedIn(true);
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Box,
      {
        sx: {
          backgroundColor: legoTheme.palette.background.default,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 4 }, children: [
...
const fixture1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: LegoHeader_fixture
}, Symbol.toStringTag, { value: "Module" }));
const LegoButton_fixture = {
  "Primary Button": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", children: "Primary Button" })
    }
  ) }),
  "Secondary Button": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "secondary", children: "Secondary Button" })
    }
  ) }),
  "Success Button": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "success", children: "Success Button" })
    }
  ) }),
  "Warning Button": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "warning", children: "Warning Button" })
    }
  ) }),
  "All Variants": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, flexWrap: "wrap", gap: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", children: "Primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "secondary", children: "Secondary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "success", children: "Success" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "warning", children: "Warning" })
      ] })
    }
  ) }),
  "All Sizes": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, alignItems: "center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", size: "small", children: "Small" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", size: "medium", children: "Medium" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", size: "large", children: "Large" })
      ] })
    }
  ) }),
  "With Icons": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, flexWrap: "wrap", gap: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", icon: "🔒", iconPosition: "left", children: "Login" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          LegoButton,
          {
            variant: "secondary",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "success", icon: "✅", iconPosition: "left", children: "Save" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          LegoButton,
          {
            variant: "warning",
  ...
  "Disabled State": () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: legoTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      sx: {
        p: 4,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "primary", disabled: true, children: "Disabled Primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegoButton, { variant: "secondary", disabled: true, children: "Disabled Secondary" })
      ] })
    }
  ) }),
  "Interactive States": () => {
...
const fixture2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: LegoButton_fixture
}, Symbol.toStringTag, { value: "Module" }));
function CosmosDecorator({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ThemeProvider, { theme: legoTheme, children: [
...
const fixtures = {
  "src/components/__fixtures__/LegoCard.fixture.tsx": { module: fixture0 },
  "src/components/__fixtures__/LegoHeader.fixture.tsx": { module: fixture1 },
  "src/components/__fixtures__/LegoButton.fixture.tsx": { module: fixture2 }
};
const decorators = {
